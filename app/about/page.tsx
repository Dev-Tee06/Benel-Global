...
const journeySteps = [
  {
    title: "Discover",
    description:
      "Deep dive into your business model, market, and goals to align on the core challenge.",
    icon: Eye,
  },
  {
    title: "Research",
    description:
      "Audit current strategies, identify bottlenecks, and gather data-driven insights.",
    icon: Compass,
  },
  {
    title: "Strategy",
    description:
      "Design a custom roadmap aligned with your revenue targets and positioning.",
    icon: Lightbulb,
  },
  {
    title: "Build",
    description:
      "Develop the required assets, systems, and campaigns for execution.",
    icon: Code2,
  },
  {
    title: "Launch",
    description:
      "Deploy the strategy into the market with precision and agility.",
    icon: Rocket,
  },
  {
    title: "Scale",
    description:
      "Optimize continuously based on performance data to accelerate growth.",
    icon: TrendingUp,
  },
];
...
export default function AboutPage() {
  return (
    <>
      {/* ===================== HERO ===================== */}
      <section className="relative pt-32 pb-24 overflow-hidden bg-bg-primary">
        <CinematicBackground />
        ...
        <div className="container-custom relative z-10">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="mt-8 text-xl text-navy-400 font-light leading-relaxed">
              We guide you through a comprehensive, interactive journey designed
              to move your business from confusion to consistent growth.
            </p>
          </AnimatedSection>
              ...
              {journeySteps.map((step, i) => (
                ...
                >
                  ...
                  >
                    <InteractiveCard>
                      <div
                        className={`service-card hover:-translate-y-2 flex flex-col items-center text-center ${i % 2 === 0 ? "md:items-end md:text-right" : "md:items-start md:text-left"}`}
                      >
                        ...
                        <p
                          className={`text-navy-300 font-light leading-relaxed text-center ${i % 2 === 0 ? "md:text-right" : "md:text-left"}`}
                        >
                          {step.description}
                        </p>
                      </div>
      ...
      <section className="relative py-24 overflow-hidden bg-bg-primary">
        <div className="container-custom relative z-10">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-display tracking-tight text-navy leading-[1.1]">
              What we stand <span className="text-cinematic-gradient">for</span>
            </h2>
          </AnimatedSection>
